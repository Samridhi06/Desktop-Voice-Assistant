...
def ai_tasks():
    ...
    while True:
        ...
        if 'what is' in command:
            ...
            command = command.replace("where am ", "")
            location = command
            url = 'https://www.google.com/maps/@30.7712513,76.5688626,16z'
            webbrowser.open(url)
        ...
        elif 'stop' in command.lower() or 'bye' in command.lower() or 'exit' in command.lower() or 'quit' in command.lower():
            print("Goodbye!")
            speak("Goodbye!")
            exit()
            ...
            speak("I am your desktop assistant SHIP")
